...
#  - Among all training clusters with k value <= current k-group that include the layer (as a string),
...
expected = {
    ...
    "6": (["k5-c1"] * 2) + (["k5-c0"] * 3) + (["k3-c1"] * 4) + (["k6-c0"] * 2) + (["k6-c1"] * 2) + (["k4-c1"] * 2),
    "7": (["k5-c1"] * 2) + (["k5-c0"] * 3) + (["k7-c1"] * 2) + (["k7-c0"] * 2) + (["k6-c0"] * 2) + (["k6-c1"] * 2) + (["k4-c1"] * 2),
    "8": (["k5-c1"] * 2) + (["k5-c0"] * 1) + (["k8-c0"] * 2) + (["k7-c1"] * 2) + (["k7-c0"] * 2) + (["k6-c0"] * 2) + (["k6-c1"] * 2) + (["k4-c1"] * 2),
}
